...
int aktest(){
    ...
    //     vector<int> eraseItems = tempShop.SetShopItems(1,3,myItems.GetRemainingShopItems());
    ...
    //     }
    //     cout<<"Shop End"<<endl<<endl;
    // }
    
    // auto [message, boughtItem] = shops[0].PlayerBuysItem(1);//1, Milk, 2. Nose Plug Enter Maount: 1
